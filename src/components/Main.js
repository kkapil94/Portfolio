...
function Main() {
  ...
  return (
    <div className="main-container-wrapper">
      ...
      <div className="bio">
        <div className='data'>
          <h1 className='author'>Kapil Khatri</h1>
